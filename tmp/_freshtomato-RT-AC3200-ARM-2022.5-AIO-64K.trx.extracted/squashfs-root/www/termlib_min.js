...
else{this.globals.hasSubDivs=(navigator.userAgent.indexOf('Gecko')<0);var s='',bgColorAttribute=(this.conf.bgColor&&(this.conf.bgColor!=='none'||this.conf.bgColor!='transparent'))?' bgcolor="'+this.conf.bgColor+'"':'',frameColorAttribute=(this.conf.frameColor&&(this.conf.frameColor!=='none'||this.conf.frameColor!='transparent'))?' bgcolor="'+this.conf.frameColor+'"':'';s+='<table style="border:0;border-collapse:collapse;border-spacing:0;padding:'+this.conf.frameWidth+'px">\n';s+='<tr><td'+frameColorAttribute+'><table style="border:0;border-collapse:collapse;border-spacing:0;padding:2px"><tr><td'+bgColorAttribute+'><table style="border:0;border-collapse:collapse;border-spacing:0;padding:0px">\n';var rstr='';for(var c=0;c<this.conf.cols;c++)rstr+='&nbsp;';for(var r=0;r<this.conf.rows;r++){var termid=(this.globals.hasSubDivs)?'':' id="'+divPrefix+r+'"';s+='<tr><td nowrap height="'+this.conf.rowHeight+'"'+termid+' class="'+this.conf.fontClass+'">'+rstr+'<\/td><\/tr>\n';}
...
this.globals.termStringStart='<table style="border:0;border-collapse:collapse;border-spacing:0;padding:0px"><tr><td nowrap height="'+this.conf.rowHeight+'" class="'+this.conf.fontClass+'">';this.globals.termStringEnd='<\/td><\/tr><\/table>';}
