...
fom['dhcp'+j+'_num'].value = (d[i][4] != '0') ? d[i][6].split('.').splice(3, 1) - (d[i][5]).split('.').splice(3, 1) + 1 : ''; 
...
fom['wan'+u+'_dns_auto'].value = '0'; 
if ((fom['wan'+u+'_proto'].value == 'disabled') || (uidx > curr_mwan_num)) { 
