...
if (iptraffic[j] != null && (avgiptraffic[i][9] + avgiptraffic[i][10] > 0)) { 
abc[j] = avgiptraffic[i][0]; 
nfmarks[j] = avgiptraffic[i][9] + avgiptraffic[i][10]; 
irates[j] = avgiptraffic[i][1]; 
orates[j] = avgiptraffic[i][2]; 
}
else
continue;
++j;
