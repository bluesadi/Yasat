...
router_reboot = 1;
if (nvram[+u+':ccode'].length > 0) 
E('_'+u+':ccode').value = c_code;
if (nvram['pci/'+u_pci+'/1/ccode'].length > 0) 
...
E('_wl'+u+'_txbf_bfr_cap').value = E('_wl'+u+'_txbf').value; 
E('_wl'+u+'_txbf_bfe_cap').value = E('_wl'+u+'_txbf').value;
E('_wl'+u+'_txbf_imp').value = E('_wl'+u+'_itxbf').value; 
E('_wl'+u+'_bss_maxassoc').value = E('_wl'+u+'_maxassoc').value; 
var wb_enable = E('_wl'+u+'_wmf_bss_enable').value;
E('_wl'+u+'_igs').value = wb_enable; 
